...
public class IkControl : MonoBehaviour
{
    ...
    public Transform leftFootObject = null;
        ...
        if (animator)
        {
            ...
            if (ikActive)
            {
                ...
                if (leftFootObject != null)
                {
                    ...
                    animator.SetIKPosition(AvatarIKGoal.LeftFoot, leftFootObject.position);
                    animator.SetIKRotation(AvatarIKGoal.LeftFoot, leftFootObject.rotation);
                }
